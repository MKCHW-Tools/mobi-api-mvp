...
router.post('/api/v1/ambulances', auth, async function(req, res){
...
router.get('/api/v1/ambulances', auth, async function (req, res) {
    try {
...
router.get('/api/v1/ambulances/:id', auth, async (req, res) => {
...
router.put('/api/v1/ambulances/:id', auth, async (req, res) => {
    try {
...
router.delete('/api/v1/ambulances/:id', auth, async (req, res) => {
    try {
        const { _id } = req.user
